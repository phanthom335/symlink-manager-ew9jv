    ...
    APP_NAME    = "Symlink Manager Ew9jv"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you monitor projects in seconds.")
